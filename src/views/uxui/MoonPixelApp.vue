...
export default {
  ...
  data() {
    return {
      ...
      viewer3D: require("@/images/moonpixel/3DViewer.mp4"),
      demo: require("@/images/moonpixel/demo.mp4"),
      optimization: require("@/images/moonpixel/Optimization.mp4"),
      solutions: require("@/images/moonpixel/Solutions.mp4"),
